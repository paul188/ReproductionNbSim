...
# scale the data according to the weights provided
...
def print_fit(region, weights):
    ...
    plt.savefig(r'C:/Users/paul1/OneDrive/Desktop/epidemiology/coding/Secihurd_Model/src/python/regional_fitting/region'+str(region+1)+'/leastsq_fit/fit.png',bbox_inches="tight")
    plt.clf()
    f = open(r'C:/Users/paul1/OneDrive/Desktop/epidemiology/coding/Secihurd_Model/src/python/regional_fitting/region' + str(region+1)+'/leastsq_fit/best_values.txt',"w+")
    f.truncate(0)
    ...
    f.write('\n')
    f.close()
    f = open(r'C:/Users/paul1/OneDrive/Desktop/epidemiology/coding/Secihurd_Model/src/python/regional_fitting/region' + str(region+1)+'/leastsq_fit/quality.txt',"w+")
